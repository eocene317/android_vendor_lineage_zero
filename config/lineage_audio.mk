...
ALARM_PATH := vendor/lineage_zero/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/lineage_zero/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/lineage_zero/prebuilt/common/media/audio/ringtones
